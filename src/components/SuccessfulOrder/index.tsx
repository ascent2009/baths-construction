...
const SuccessfulOrder: React.FC = () => {
  ...
  // const repeatedImages= sortedImages.repeat(2);
  // const repeatedImages = new Array(2).fill(sortedImages).flat();
  return (
    <>
      <HeaderMain
      ...
      <section className={s.main}>
        <article className={s.main_success}>
          ...
          <div className={s.main_success__text}>
            <p>Мы свяжемся с Вами в ближайшее время и ответим на все возникшии вопросы, примем заказ или договоримся о времени посещения нашего производства.</p>
            <p>Обычно мы перезваниваем в течении 10 минут в рабочие часы с 09:00 до 20:00 семь дней в неделю.</p>
          </div>          
        </article>
        <article className={s.main_examples}>
          <div className={s.main_examples__title}>
            <h3>А пока вы ждете нашего звонка,  посмотрите фотогалерею наших рабочих будней</h3>
            <div className={s.main_examples__title_link}>
                <h4>Каталог</h4>
                <A href="/catalogue">Перейти в каталог наших бань</A>
            </div>
          </div>
          <ul className={s.main_examples__images} style={{marginBottom: "43px"}}>
