...
const About: React.FC<IAbout> = ({ className }) =>
  {
    ...
    return (
      <>
        <article className={s[`${className}`]} id={"about"}>
          ...
          <ul className={s.main_about__images}>
            ...
            <div className={s.main_about__details}>
              ...
              <h3 className={s.main_about__details_phone}>
                +7 (812) 467-90-60
              </h3>
          ...
          {!modal ? (
            <div>
              <Overlay />
              <Modal className={s.main_modal__about} id="modalAbout">
                <button
                ...
                <div className={s.main_modal__about_block}>
                  ...
                  <p className={s.main_modal__about_text}>
                    ...
                    Заполните форму ниже и мы сами перезвоним в течении 10
                    минут, звонок бесплатный, и совершенно не к чему Вас не
                    обязывает.
                  </p>
                  <form
